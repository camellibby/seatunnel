...
@Slf4j
public class SqlCdcSourceSplitEnumerator implements SourceSplitEnumerator<SqlCdcSourceSplit, ArrayList<SqlCdcSourceSplit>> {
    ...
    public SqlCdcSourceSplitEnumerator(SourceSplitEnumerator.Context<SqlCdcSourceSplit> enumeratorContext, SqlCdcConfig sqlCdcConfig) {
