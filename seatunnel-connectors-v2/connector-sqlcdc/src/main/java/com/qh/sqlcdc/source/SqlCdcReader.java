...
public class SqlCdcReader implements SourceReader<SeaTunnelRow, SqlCdcSourceSplit> {
    ...
    SqlCdcReader(SqlCdcConfig sqlCdcConfig, SourceReader.Context context, SeaTunnelRowType typeInfo) {
    ...
    public void pollNext(Collector<SeaTunnelRow> output) throws Exception {
        ...
        try (Connection conn = util.getConnection(sourceJdbcConfig)) {
            ...
            SeaTunnelRowType typeInfo = getTypeInfo(conn, jdbcDialect, this.sqlCdcConfig.getQuery());
