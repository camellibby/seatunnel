...
public class CodeConverter {
    ...
    public String convert(String safeCode, String str) {
    ...
    public String dmConverter(String safeCode,String str) {
            return dmMap.get(safeCode + '.' + str);
    }
    public String encryptConverter(String safeCode, String str) {
